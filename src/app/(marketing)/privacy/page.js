    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-8">
            ...
            <section className="mb-8">
                ...
                <p className="mb-4">
                    Welcome to SmartGrAIder. We respect your privacy and are committed to protecting your personal data. This privacy policy will inform you as to how we look after your personal data when you visit our website and tell you about your privacy rights and how the law protects you.
                </p>
            </section>
            ...
            <section className="mb-8">
                ...
                <p className="mb-4">
                    SmartGrAIder is an application designed to assist educators in grading assignments using Google Classroom. To provide this service, we collect and process the following data through the Google API:
                </p>
            ...
            <section className="mb-8">
                ...
                <p className="mb-4">We use the information we collect solely for the purpose of providing and improving the SmartGrAIder service:</p>
                <ul className="list-disc pl-6 mb-4 space-y-2">
                    <li>To authenticate your identity and manage your session.</li>
                    <li>To display your courses and assignments within the SmartGrAIder interface.</li>
            ...
            <section className="mb-8 bg-blue-50 p-6 rounded-lg border border-blue-100">
                ...
                <p className="mb-2 text-blue-800">
                    SmartGrAIder's use and transfer to any other app of information received from Google APIs will adhere to the{' '}
            ...
            <section className="mb-8">
                ...
                <p className="mb-4">
                    You have the right to revoke SmartGrAIder's access to your Google account at any time by visiting your Google Account settings page. If you choose to revoke access, SmartGrAIder will no longer be able to function.
                </p>
            </section>
